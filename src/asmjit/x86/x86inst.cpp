...
const X86InstInfo _x86InstInfo[] = {
  ...
  INST(kX86InstIdLodsb            , "lodsb"            , G(X86Op)         , F(None)|F(Special)     , 0 , U                   , U                   , U                   , U                   , O_000000(AC,U)  , U               ),
  INST(kX86InstIdLodsd            , "lodsd"            , G(X86Op)         , F(None)|F(Special)     , 0 , U                   , U                   , U                   , U                   , O_000000(AD,U)  , U               ),
  INST(kX86InstIdLodsq            , "lodsq"            , G(X86Op)         , F(None)|F(Special)|F(W), 0 , U                   , U                   , U                   , U                   , O_000000(AD,U)  , U               ),
  INST(kX86InstIdLodsw            , "lodsw"            , G(X86Op_66H)     , F(None)|F(Special)     , 0 , U                   , U                   , U                   , U                   , O_000000(AD,U)  , U               ),
